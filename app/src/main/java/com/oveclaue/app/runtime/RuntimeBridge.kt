...
object RuntimeLaunchConfigBuilder {
    fun build(profile: ProviderProfile, authToken: String? = null, localGatewayUrl: String? = null): RuntimeLaunchConfig {
        ...
        when (profile.kind.protocol) {
            com.oveclaue.app.model.ProviderProtocol.CLAUDE_LOGIN -> {
            ...
            com.oveclaue.app.model.ProviderProtocol.ANTHROPIC -> {
                environment["ANTHROPIC_BASE_URL"] = profile.baseUrl.trimEnd('/')
                environment["ANTHROPIC_MODEL"] = profile.model
            }
            com.oveclaue.app.model.ProviderProtocol.ANTHROPIC_GATEWAY -> {
                environment["ANTHROPIC_BASE_URL"] = profile.baseUrl.trimEnd('/')
                environment["ANTHROPIC_MODEL"] = profile.model
            }
            com.oveclaue.app.model.ProviderProtocol.OPENROUTER -> {
                environment["ANTHROPIC_BASE_URL"] = profile.baseUrl.trimEnd('/')
                environment["ANTHROPIC_MODEL"] = profile.model
            }
            com.oveclaue.app.model.ProviderProtocol.OPENAI_RESPONSES,
            com.oveclaue.app.model.ProviderProtocol.OPENAI_CHAT,
            -> {
        ...
        if (profile.kind.protocol != com.oveclaue.app.model.ProviderProtocol.CLAUDE_LOGIN) {
            ...
            if (!authToken.isNullOrBlank()) {
                ...
                if (profile.kind == com.oveclaue.app.model.ProviderKind.LLM_ROUTER) {
                    environment["ANTHROPIC_API_KEY"] = ""
