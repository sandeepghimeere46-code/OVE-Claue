# OVE Claue Privacy Policy

**Effective date:** August 24, 2026

OVE Claue is a local-first Android development workspace. This policy explains what information the app handles, where it is stored, and when information leaves the device.

## Information handled by the app

OVE Claue may handle the following information when you choose to provide it:
...
OVE Claue does not currently include advertising or analytics SDKs and does not operate a first-party user account system.
...
OVE Claue does not sell personal information. It does not send projects or conversations to the OVE Claue developer unless you explicitly share them, submit diagnostics, or use a future opt-in backup or support feature.
...
- **Install packages:** Submit an Android APK built in your selected project to Android's system installer. Android asks you to allow this source and confirm installation; OVE Claue cannot silently install apps.
...
Local information remains on the device until you delete the relevant project, clear it from the app, or uninstall OVE Claue. Uninstalling the app removes its private local data according to Android's behavior.
...
OVE Claue uses app-private Android storage, Android Keystore-backed credential encryption, HTTPS for external services, and checksum verification for supported runtime downloads. No system can guarantee complete security. Code executed inside the local Linux environment should be limited to projects and dependencies you trust.

## Children

OVE Claue is a developer tool and is not directed to children under 13. The app does not knowingly collect personal information from children.

## Changes to this policy

This policy may be updated as OVE Claue changes. Material changes will be reflected by updating the effective date and publishing the revised policy at the same public URL.

## Contact

For privacy questions or requests, open an issue at [github.com/techexample/OVE-Claue/issues](https://github.com/techexample/OVE-Claue/issues).
